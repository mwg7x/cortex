...
function allPairsRespectGap(timesA, timesB, minHours) {
...
function optimizeSchedule(schedule, interactions) {
...
export function analyzePrescription(input) {
    ...
    const isSafe = !interactions.some((interaction) => interaction.severity === "contraindicated" ||
